...
class CreateProjectActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityCreateProjectBinding.inflate(LayoutInflater.from(this))
        ...
        mViewModel = ViewModelProvider(
            this, CreateProjectViewModelFactory(
    ...
    private fun setupObservers() {
        ...
        mViewModel.getCreateProject().observe(this) {
            if (it != null) {
        ...
        if (errorMessage != null) {
            mBinding.projectNameTil.apply {
                ...
                if (shouldVibrateView) VibrateView.vibrate(
                    this@CreateProjectActivity, this
                )
            }
        }
