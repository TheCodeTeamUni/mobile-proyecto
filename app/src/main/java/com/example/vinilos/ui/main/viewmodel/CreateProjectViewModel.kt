...
class CreateProjectViewModel(
    ...
    private var createProject: MutableLiveData<Int> = MutableLiveData()

    fun getIsLoading(): LiveData<Boolean> = isLoading
    fun getErrorMessage(): LiveData<HashMap<String, String>> = errorMessage
    fun getCreateProject(): LiveData<Int> = createProject

    fun createProject(body: CreateProjectBody) {
        viewModelScope.launch {
            registerInformation.createProject(body).collect {
                when (it) {
                    ...
                    is RequestStatus.Success -> {
                        ...
                        createProject.value = it.data.id
